...
class AddImageAnnotation {
	static async Run() {
		...
		a1.penWidth = 1;
		a1.type = annotation_cloud.AnnotationInfo.TypeEnum.Image;
		a1.text = "This is image annotation";
		a1.creatorName = "Anonym A.";
		a1.imagePath = "annotationdocs/JohnSmith.png";
		...
		console.log("AddImageAnnotation: image Annotation added: " + result.href);
	}
}
module.exports = AddImageAnnotation;
